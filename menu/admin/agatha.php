...
<head>
    ...
    <link rel="stylesheet" href="../../styles/agatha.css">
            ...
            <div class = "right-menu">
                <div class="patterns">
                    <svg width="360%" height="120%">
                        ...
                        <text x="59%" y="155px" text-anchor="middle">Agatha</text>
                    </svg>
                </div>
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                              <h1 class="text-shadow"> Perez </h1>
                                    <div class="tags"></div>
                            </svg>
                            </div>
                            <div class="flip-card-back" style="border: 1px solid; border-color: #6cd2f4; color: #37a0cf;";>
                            <p class="text fw-bold">Cyra Shane R. Perez</p>
                            <p class="text fw-bold">Front-End Developer</p>
                            <p class="text fw-bold" style="margin-left: 10px; margin-right:10px; color: #37a0cf;";>FEU Institute of Technology 3rd Year Software Engineering Student</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container_card1">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                            <h1 class="text-shadow"> Pacheco </h1>
                                    <div class="tags"></div>
                            </svg>
                            </div>
                            <div class="flip-card-back" style="border: 1px solid; border-color: #6cd2f4; color: #37a0cf;";>
                            <p class="text fw-bold">Samuel Jacob Pacheco</p>
                            <p class="text fw-bold">Project Manager</p>
                            <p class="text fw-bold" style="margin-left: 10px; margin-right:10px; color: #37a0cf;";>FEU Institute of Technology 3rd Year Software Engineering Student</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container_card3">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                            <h1 class="text-shadow"> Signo </h1>
                                    <div class="tags"></div>
                            </svg>
                            </div>
                            <div class="flip-card-back" style="border: 1px solid; border-color: #6cd2f4; color: #37a0cf;";>
                            <p class="text fw-bold">John Benedict Signo</p>
                            <p class="text fw-bold">Lead Programmer</p>
                            <p class="text fw-bold" style="margin-left: 10px; margin-right:10px; color: #37a0cf;";>FEU Institute of Technology 3rd Year Software Engineering Student</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container_card4">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                            <h1 class="text-shadow"> Wong </h1>
                                    <div class="tags"></div>
                            </svg>
                            </div>
                            <div class="flip-card-back" style="border: 1px solid; border-color: #6cd2f4; color: #37a0cf;";>
                            <p class="text fw-bold">Ella Belle Wong</p>
                            <p class="text fw-bold">Programmer 1</p>
                            <p class="text fw-bold" style="margin-left: 10px; margin-right:10px; color: #37a0cf;";>FEU Institute of Technology 3rd Year Software Engineering Student</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container_right"  style="left:68%";>
                ...
                <div class="container_tip">
                    <h4 class="wordCarousel">
                        <div>
                            <ul class="flip3">
                                <li>Tip: Hover your cursor across the card to flip!</li>
                            </ul>
                        </div>
                    </h4>
                </div>
