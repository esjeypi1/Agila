...
<body>
               ...
               <div class="right-menu" style="overflow-y: auto; overflow-x: hidden;"> <!-- Right Canvas (START) -->
                <div class="patterns">
                    <svg width="400%" height="150%">
                        ...
                        <text x="54%" y="17%" text-anchor="middle" style="font-size: 40px;">Year 2023</text>
    ...
    (async function() {
        ...
        async function fetchData() {
            ...
            const filteredData = jsonData.filter(row => parseInt(row.YEAR) === 2023);
    ...
    (async function() {
        ...
        async function fetchData() {
            ...
            const crimeTypes = {};
             ...
             const filteredData1 = jsonData.filter(row => parseInt(row.YEAR) === 2023);
