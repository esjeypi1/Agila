        ...
        <div class="right-menu" style="overflow-y: auto; overflow-x: hidden;"> <!-- Right Canvas (START) -->
          <div class="patterns">
            <svg width="400%" height="150%">
              ...
              <text x="54%" y="17%" text-anchor="middle" style="font-size: 40px;">Year 2020</text>
                      ...
                      <script>
                        (async function() {
                          ...
                          async function fetchData() {
                            ...
                            const filteredData = jsonData.filter(row => parseInt(row.YEAR) === 2020);
                      ...
                      <script>
                        (async function() {
                          ...
                          async function fetchData1() {
                            ...
                            const filteredData1 = jsonData.filter(row => parseInt(row.YEAR) === 2020);
          ...
          <div class="container_left btn-conteiner">
            <a href ="stats_2024.php" class = "btn-content">
          ...
          <div class="container_right btn-conteiner">
            <a href ="stats_2021.php" class = "btn-content">
              <span class="icon-arrow">
                <svg
                     xmlns:xlink="http://www.w3.org/1999/xlink"
                     xmlns="http://www.w3.org/2000/svg"
