...
<body>
               ...
               <div class="right-menu" style="overflow-y: auto; overflow-x: hidden;"> <!-- Right Canvas (START) -->
                <div class="patterns">
                    <svg width="400%" height="150%">
                        ...
                        <text x="54%" y="17%" text-anchor="middle" style="font-size: 40px;">Year 2021</text>
    ...
    (async function() {
        ...
        async function fetchData() {
            ...
            // Filter the JSON data for the year 2020
            const filteredData = jsonData.filter(row => parseInt(row.YEAR) === 2021);
          console.log("Filtered data (2020):", filteredData); // Log filtered data
    ...
    (async function() {
        ...
        async function fetchData() {
            ...
            const crimeTypes = {};
             ...
             const filteredData1 = jsonData.filter(row => parseInt(row.YEAR) === 2021);
          console.log("Filtered data (2021):", filteredData1); // Log filtered data
        ...
        drawChart2();
                ...
                <div class="container_right btn-conteiner">
                    <a href ="stats_2022.php" class = "btn-content">
                    <span class="icon-arrow">
                                <svg
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                    xmlns="http://www.w3.org/2000/svg"
